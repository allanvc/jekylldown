...
want a regular [git installation](https://git-scm.com/downloads)). The whole workflow — `install_ruby()`, `new_site()`,
`build_site()`, `serve_site()` — runs on a Windows GitHub Actions
