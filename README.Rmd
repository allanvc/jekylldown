...
git is absent. (One exception: al-folio's `bundle_install()` needs git,
because its `Gemfile` pulls a gem from a git repository — install it
from [git-scm.com](https://git-scm.com/downloads) if you use that
theme.) The whole workflow — `install_ruby()`, `new_site()`,
